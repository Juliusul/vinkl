...
const styles = StyleSheet.create({
  ...
  metaBlock: { fontSize: 9, color: "#666", textAlign: "right" },
  divider: { borderBottomWidth: 1, borderBottomColor: "#e0e0e0", marginVertical: 20 },
  ...
  tableHeader: { flexDirection: "row", backgroundColor: "#f5f5f5", padding: "6 8", fontFamily: "Helvetica-Bold", fontSize: 9 },
  tableRow: { flexDirection: "row", padding: "8 8", borderBottomWidth: 1, borderBottomColor: "#f0f0f0" },
  ...
  totalRowBold: { flexDirection: "row", width: 200, justifyContent: "space-between", paddingVertical: 4, borderTopWidth: 1, borderTopColor: "#1a1a1a", marginTop: 4 },
  boldText: { fontFamily: "Helvetica-Bold" },
  footer: { position: "absolute", bottom: 40, left: 48, right: 48, fontSize: 8, color: "#999", borderTopWidth: 1, borderTopColor: "#e0e0e0", paddingTop: 10, flexDirection: "row", justifyContent: "space-between" },
  paidStamp: { marginTop: 24, alignSelf: "flex-start", borderWidth: 2, borderColor: "#2d7a2d", borderRadius: 4, paddingHorizontal: 12, paddingVertical: 4 },
  paidText: { color: "#2d7a2d", fontFamily: "Helvetica-Bold", fontSize: 11, letterSpacing: 2 },
});
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.tableRow}>
          ...
          <Text style={styles.col3}>{fmt(net / parseInt(qty))}</Text>
