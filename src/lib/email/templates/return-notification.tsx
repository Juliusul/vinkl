...
export function ReturnNotificationEmail({
  ...
  return (
    <Html lang="de">
      <Head />
      <Preview>Deine Rückgabe zur Bestellung {invoiceNumber} wurde erfasst</Preview>
      <Body style={{ fontFamily: "Georgia, serif", backgroundColor: "#f5f0ea", margin: 0, padding: "32px 0" }}>
        <Container style={{ maxWidth: 560, margin: "0 auto", backgroundColor: "#fff", padding: "48px 40px" }}>
          ...
          <Text style={{ fontSize: 14, color: "#666", margin: "0 0 32px", lineHeight: 1.6 }}>
            ...
            Sobald das Paket bei uns eingetroffen ist, werden wir dich informieren.
          </Text>
          ...
          <Section style={{ backgroundColor: "#f9f7f4", padding: "20px 24px", marginBottom: 32 }}>
            ...
            <Row style={{ marginBottom: 8 }}>
              ...
              <Column style={{ textAlign: "right" }}><Text style={{ fontSize: 13, color: "#1a1a1a", margin: 0 }}>{returnDate}</Text></Column>
            </Row>
            <Row>
